        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-lg">
                ...
                <div className="flex items-center gap-2">
                    <div className={`w-3 h-3 rounded-full ${status.includes('Online') ? 'bg-emerald-500' : 'bg-red-500'}`}></div>
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-lg">
                <div className="flex items-center gap-3 mb-4 text-emerald-400">
                    ...
                    <h2 className="text-xl font-semibold">Security Vault</h2>
                </div>
                <p className="text-slate-400 text-sm mb-4">
                    Local encryption active. PII is isolated.
                </p>
                <div className="flex justify-between items-center mt-4">
                    <span className="text-2xl font-bold">{stats.total_letters}</span>
            ...
            <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-lg">
                <div className="flex items-center gap-3 mb-4 text-purple-400">
                    ...
                    <h2 className="text-xl font-semibold">Pending Letters</h2>
                </div>
                <div className="text-3xl font-bold mb-2">{stats.pending_action}</div>
                <p className="text-slate-500 text-xs">Awaiting synchronization</p>
            </div>
